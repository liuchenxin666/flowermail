    ...
    if (index.column() == 0)
       {
        ...
        QPixmap  star;
        if(index.data().toString()=="yes") star.load(":/new/prefix1/red_star.png");
        else if(index.data().toString()=="no") star.load(":/new/prefix1/gray_star.png");
        ...
        QPixmap  star;
        if(b) star=QPixmap(":/new/prefix1/unread.png");
        int width=star.width();
        int height=star.height();
        QRect rect=option.rect;
        int x=rect.x()+rect.width()/2-width/2;
